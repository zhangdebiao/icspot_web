    ...
    <el-table-column type="expand">
      <template slot-scope="props">
        <el-form label-position="left" inline class="demo-table-expand">
          <el-form-item v-if="props.row.request" label="REQUEST: ">
          ...
          <el-form-item v-if="props.row.sensorid" label="SONSORID: ">
          ...
          <el-form-item v-if="props.row.protocol" label="PROTOLCOL: ">
