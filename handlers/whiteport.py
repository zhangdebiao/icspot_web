...
from service.whiteportservice import whiteports, insertports, deleteports, updateports
...
class WhiteportHandler(BaseHandler):
    ...
    def post(self):
        ...
        print("_________________________updatewhiteport____________________________")
        print(port_list)
        updateports(port_list)
        print("_________________________portok____________________________")
